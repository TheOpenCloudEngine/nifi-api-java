...
public class ProcessorsApi {
    ...
    private com.squareup.okhttp.Call analyzeConfigurationCall(String id, ConfigurationAnalysisEntity body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/processors/{id}/config/analysis".replaceAll("\\{format\\}", "json")
    ...
    public ApiResponse<ProcessorEntity> deleteProcessorWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        com.squareup.okhttp.Call call = deleteProcessorCall(id, version, clientId, disconnectedNodeAcknowledged, null, null);
    ...
    private com.squareup.okhttp.Call deleteVerificationRequestCall(String id, String requestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/processors/{id}/config/verification-requests/{requestId}".replaceAll("\\{format\\}", "json")
                .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()))
    ...
    public ApiResponse<ProcessorEntity> getProcessorDiagnosticsWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getProcessorDiagnosticsCall(id, null, null);
        Type localVarReturnType = new TypeToken<ProcessorEntity>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<ProcessorsRunStatusDetailsEntity> getProcessorRunStatusDetailsWithHttpInfo(RunStatusDetailsRequestEntity body) throws ApiException {
        com.squareup.okhttp.Call call = getProcessorRunStatusDetailsCall(body, null, null);
    ...
    private com.squareup.okhttp.Call getPropertyDescriptorCall(String id, String propertyName, String clientId, Boolean sensitive, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<PropertyDescriptorEntity> getPropertyDescriptorWithHttpInfo(String id, String propertyName, String clientId, Boolean sensitive) throws ApiException {
        com.squareup.okhttp.Call call = getPropertyDescriptorCall(id, propertyName, clientId, sensitive, null, null);
    ...
    private com.squareup.okhttp.Call submitProcessorVerificationRequestCall(String id, VerifyConfigRequestEntity body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        ...
        // create path and map variables
        String localVarPath = "/processors/{id}/config/verification-requests".replaceAll("\\{format\\}", "json")
                .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    public ApiResponse<VerifyConfigRequestEntity> submitProcessorVerificationRequestWithHttpInfo(String id, VerifyConfigRequestEntity body) throws ApiException {
        com.squareup.okhttp.Call call = submitProcessorVerificationRequestCall(id, body, null, null);
        Type localVarReturnType = new TypeToken<VerifyConfigRequestEntity>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<ProcessorEntity> terminateProcessorWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = terminateProcessorCall(id, null, null);
        Type localVarReturnType = new TypeToken<ProcessorEntity>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<ProcessorEntity> updateRunStatusWithHttpInfo(String id, ProcessorRunStatusEntity body) throws ApiException {
        com.squareup.okhttp.Call call = updateRunStatusCall(id, body, null, null);
        Type localVarReturnType = new TypeToken<ProcessorEntity>() {
        }.getType();
        return apiClient.execute(call, localVarReturnType);
    }
