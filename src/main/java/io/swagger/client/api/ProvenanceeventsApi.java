...
public class ProvenanceeventsApi {
    ...
    private com.squareup.okhttp.Call submitReplayLatestEventCall(ReplayLastEventRequestEntity body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        ...
        // create path and map variables
        String localVarPath = "/provenance-events/latest/replays".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<ReplayLastEventResponseEntity> submitReplayLatestEventWithHttpInfo(ReplayLastEventRequestEntity body) throws ApiException {
        com.squareup.okhttp.Call call = submitReplayLatestEventCall(body, null, null);
