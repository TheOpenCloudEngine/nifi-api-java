...
public class ConnectionsApi {
    ...
    private com.squareup.okhttp.Call deleteConnectionCall(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<ConnectionEntity> deleteConnectionWithHttpInfo(String id, String version, String clientId, Boolean disconnectedNodeAcknowledged) throws ApiException {
        com.squareup.okhttp.Call call = deleteConnectionCall(id, version, clientId, disconnectedNodeAcknowledged, null, null);
