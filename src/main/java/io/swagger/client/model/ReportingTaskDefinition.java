...
public class ReportingTaskDefinition {
     ...
     **/
    @ApiModelProperty(example = "null", value = "The supported scheduling strategies, such as TIME_DRIVER or CRON.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The default scheduling strategy for the reporting task.")
