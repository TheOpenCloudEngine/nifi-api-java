...
public class LocalQueuePartitionDTO {
     ...
     **/
    @ApiModelProperty(example = "null", value = "Whether or not all of the FlowFiles in the Active Queue are penalized")
     ...
     **/
    @ApiModelProperty(example = "null", value = "Whether or not any of the FlowFiles in the Active Queue are penalized")
