...
public class ControllerServiceReferencingComponentDTO   {
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "The type of the component referencing a controller service in simple Java class name format without package name.")
