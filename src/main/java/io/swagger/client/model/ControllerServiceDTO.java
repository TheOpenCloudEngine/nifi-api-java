...
public class ControllerServiceDTO   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Whether the controller service supports sensitive dynamic properties.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Indicates whether the ControllerService is valid, invalid, or still in the process of validating (i.e., it is unknown whether or not the ControllerService is valid)")
