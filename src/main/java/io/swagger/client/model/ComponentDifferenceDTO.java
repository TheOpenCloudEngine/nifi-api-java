...
public class ComponentDifferenceDTO   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The type of component")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The ID of the Process Group that the component belongs to")
   ...
   * @return differences
  **/
  @ApiModelProperty(example = "null", value = "The differences in the component between the two flows")
