...
public class FlowFileDTO {
     ...
     * @return attributes
     **/
    @ApiModelProperty(example = "null", value = "The FlowFile attributes.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The section in which the content claim lives.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The container in which the content claim lives.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The identifier of the content claim.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The offset into the content claim where the flowfile's content begins.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The file size of the content claim formatted.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The file size of the content claim in bytes.")
