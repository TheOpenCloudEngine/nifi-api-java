...
public class ProcessGroupDTO {
     ...
     **/
    @ApiModelProperty(example = "null", value = "The Outbound Policy that is used for determining how FlowFiles should be transferred out of the Process Group.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The default FlowFile Expiration for this Process Group.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "Default value used in this Process Group for the maximum number of objects that can be queued before back pressure is applied.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "Default value used in this Process Group for the maximum data size of objects that can be queued before back pressure is applied.")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, versionedComponentId, parentGroupId, position, name, comments, variables, versionControlInformation, parameterContext, flowfileConcurrency, flowfileOutboundPolicy, defaultFlowFileExpiration, defaultBackPressureObjectThreshold, defaultBackPressureDataSizeThreshold, runningCount, stoppedCount, invalidCount, disabledCount, activeRemotePortCount, inactiveRemotePortCount, upToDateCount, locallyModifiedCount, staleCount, locallyModifiedAndStaleCount, syncFailureCount, localInputPortCount, localOutputPortCount, publicInputPortCount, publicOutputPortCount, contents, outputPortCount, inputPortCount);
    }
    ...
    public enum FlowfileConcurrencyEnum {
        ...
        @SerializedName("SINGLE_BATCH_PER_NODE")
