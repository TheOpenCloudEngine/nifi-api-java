...
public class ParameterProviderDTO   {
  ...
  private List<ParameterGroupConfigurationEntity> parameterGroupConfigurations = new ArrayList<ParameterGroupConfigurationEntity>();
  ...
  private List<ParameterStatusDTO> parameterStatus = new ArrayList<ParameterStatusDTO>();

  @SerializedName("referencingParameterContexts")
  private List<ParameterProviderReferencingComponentEntity> referencingParameterContexts = new ArrayList<ParameterProviderReferencingComponentEntity>();
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "The fully qualified type of the parameter provider.")
   ...
   * @return bundle
  **/
  @ApiModelProperty(example = "null", value = "The details of the artifact that bundled this parameter provider type.")
   ...
   * @return comments
  **/
  @ApiModelProperty(example = "null", value = "The comments of the parameter provider.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Whether the parameter provider persists state.")
   ...
   * @return restricted
  **/
  @ApiModelProperty(example = "null", value = "Whether the parameter provider requires elevated privileges.")
   ...
   * @return deprecated
  **/
  @ApiModelProperty(example = "null", value = "Whether the parameter provider has been deprecated.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Whether the parameter provider has multiple versions available.")
   ...
   * @return properties
  **/
  @ApiModelProperty(example = "null", value = "The properties of the parameter provider.")
   ...
   * @return descriptors
  **/
  @ApiModelProperty(example = "null", value = "The descriptors for the parameter providers properties.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Configuration for any fetched parameter groups.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The set of all components in the flow that are referencing Parameters provided by this provider")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The status of all provided parameters for this parameter provider")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The Parameter Contexts that reference this Parameter Provider")
   ...
   * @return customUiUrl
  **/
  @ApiModelProperty(example = "null", value = "The URL for the custom configuration UI for the parameter provider.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The annotation data for the parameter provider. This is how the custom UI relays configuration to the parameter provider.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Gets the validation errors from the parameter provider. These validation errors represent the problems with the parameter provider that must be resolved before it can be scheduled to run.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Indicates whether the Parameter Provider is valid, invalid, or still in the process of validating (i.e., it is unknown whether or not the Parameter Provider is valid)")
