...
public class ProcessGroupEntity   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(revision, id, uri, position, permissions, bulletins, disconnectedNodeAcknowledged, component, status, versionedFlowSnapshot, runningCount, stoppedCount, invalidCount, disabledCount, activeRemotePortCount, inactiveRemotePortCount, versionedFlowState, upToDateCount, locallyModifiedCount, staleCount, locallyModifiedAndStaleCount, syncFailureCount, localInputPortCount, localOutputPortCount, publicInputPortCount, publicOutputPortCount, parameterContext, outputPortCount, inputPortCount);
  }
