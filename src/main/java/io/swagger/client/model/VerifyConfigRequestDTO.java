...
public class VerifyConfigRequestDTO {
    ...
    private List<VerifyConfigUpdateStepDTO> updateSteps = new ArrayList<VerifyConfigUpdateStepDTO>();
    ...
    private List<ConfigVerificationResultDTO> results = new ArrayList<ConfigVerificationResultDTO>();
    ...
    public VerifyConfigRequestDTO submissionTime(DateTime submissionTime) {
    ...
    public VerifyConfigRequestDTO lastUpdated(DateTime lastUpdated) {
     ...
     * @return componentId
     **/
    @ApiModelProperty(example = "null", value = "The ID of the component whose configuration was verified")
     ...
     * @return properties
     **/
    @ApiModelProperty(example = "null", value = "The configured component properties")
     ...
     * @return attributes
     **/
    @ApiModelProperty(example = "null", value = "FlowFile Attributes that should be used to evaluate Expression Language for resolving property values")
     ...
     * @return results
     **/
    @ApiModelProperty(example = "null", value = "The Results of the verification")
