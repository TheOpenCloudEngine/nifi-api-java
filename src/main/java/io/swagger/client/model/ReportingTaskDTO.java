...
public class ReportingTaskDTO   {
  ...
  **/
   ...
   * @return bundle
  **/
  @ApiModelProperty(example = "null", value = "The details of the artifact that bundled this reporting task type.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The frequency with which to schedule the reporting task. The format of the value will depend on the value of the schedulingStrategy.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Indicates whether the Reporting Task is valid, invalid, or still in the process of validating (i.e., it is unknown whether or not the Reporting Task is valid)")
