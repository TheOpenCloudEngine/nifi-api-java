...
public class SearchResultsDTO {
    ...
    private List<ComponentSearchResultDTO> parameterProviderNodeResults = new ArrayList<ComponentSearchResultDTO>();
     ...
     **/
    @ApiModelProperty(example = "null", value = "The parameter provider nodes that matched the search")
