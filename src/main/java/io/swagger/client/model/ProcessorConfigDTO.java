...
public class ProcessorConfigDTO   {
  ...
  private List<String> retriedRelationships = new ArrayList<String>();
  ...
  public enum BackoffMechanismEnum {
    @SerializedName("PENALIZE_FLOWFILE")
    PENALIZE_FLOWFILE("PENALIZE_FLOWFILE"),
    
    @SerializedName("YIELD_PROCESSOR")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The amount of time that is used when the process penalizes a flowfile.")
  ...
  **/
   ...
   * @return retryCount
  **/
  @ApiModelProperty(example = "null", value = "Overall number of retries.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "All the relationships should be retried.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Determines whether the FlowFile should be penalized or the processor should be yielded between retries.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Maximum amount of time to be waited during a retry period.")
