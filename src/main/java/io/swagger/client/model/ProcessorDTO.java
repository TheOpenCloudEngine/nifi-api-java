...
public class ProcessorDTO {
     ...
     **/
    @ApiModelProperty(example = "null", value = "Whether the processor supports sensitive dynamic properties.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "Indicates if the execution node of a processor is restricted to run only on the primary node")
