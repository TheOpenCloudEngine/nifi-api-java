...
public class VersionedResourceDefinition   {
   ...
   * @return cardinality
  **/
  @ApiModelProperty(example = "null", value = "The cardinality of the resource")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The types of resource that the Property Descriptor is allowed to reference")
