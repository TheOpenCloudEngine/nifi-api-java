...
public class ControllerStatusDTO   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of terminated threads in the NiFi.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of up to date versioned process groups in the NiFi.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of locally modified versioned process groups in the NiFi.")
   ...
   * @return staleCount
  **/
  @ApiModelProperty(example = "null", value = "The number of stale versioned process groups in the NiFi.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of locally modified and stale versioned process groups in the NiFi.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of versioned process groups in the NiFi that are unable to sync to a registry.")
