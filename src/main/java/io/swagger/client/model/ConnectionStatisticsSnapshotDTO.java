...
public class ConnectionStatisticsSnapshotDTO {
     ...
     **/
    @ApiModelProperty(example = "null", value = "The predicted percentage of queued objects at the next configured interval.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The predicted percentage of bytes in the queue against current threshold at the next configured interval.")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The prediction interval in seconds")
