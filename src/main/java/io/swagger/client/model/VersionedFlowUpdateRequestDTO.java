...
public class VersionedFlowUpdateRequestDTO {
     ...
     **/
    @ApiModelProperty(example = "null", value = "The VersionControlInformation that describes where the Versioned Flow is located; this may not be populated until the request is completed.")
