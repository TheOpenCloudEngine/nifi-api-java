...
public class ParameterDTO {
     ...
     * @return valueRemoved
     **/
    @ApiModelProperty(example = "null", value = "Whether or not the value of the Parameter was removed. When a request is made to change a parameter, the value may be null. The absence of the value may be used either to indicate that the value is not to be changed, or that the value is to be set to null (i.e., removed). This denotes which of the two scenarios is being encountered.")
     ...
     * @return provided
     **/
    @ApiModelProperty(example = "null", value = "Whether or not the Parameter is provided by a ParameterProvider")
     ...
     **/
    @ApiModelProperty(example = "null", value = "A reference to the Parameter Context that contains this one")
     ...
     * @return inherited
     **/
    @ApiModelProperty(example = "null", value = "Whether or not the Parameter is inherited from another context")
