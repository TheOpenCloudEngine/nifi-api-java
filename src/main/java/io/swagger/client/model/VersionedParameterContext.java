...
public class VersionedParameterContext {
    ...
    private List<String> inheritedParameterContexts = new ArrayList<String>();
     ...
     **/
    @ApiModelProperty(example = "null", value = "The names of additional parameter contexts from which to inherit parameters")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The identifier of an optional parameter provider")
     ...
     **/
    @ApiModelProperty(example = "null", value = "The corresponding parameter group name fetched from the parameter provider, if applicable")
     ...
     **/
    @ApiModelProperty(example = "null", value = "True if the parameter provider is set and the context should receive updates when its parameters are next fetched")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(identifier, instanceIdentifier, name, comments, position, parameters, inheritedParameterContexts, description, parameterProvider, parameterGroupName, componentType, _synchronized, groupIdentifier);
    }
