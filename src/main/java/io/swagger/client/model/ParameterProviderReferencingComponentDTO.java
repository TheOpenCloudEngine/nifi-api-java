...
public class ParameterProviderReferencingComponentDTO {
     ...
     * @return id
     **/
    @ApiModelProperty(example = "null", value = "The id of the component referencing a parameter provider.")
    public String getId() {
        return id;
    }
     ...
     * @return name
     **/
    @ApiModelProperty(example = "null", value = "The name of the component referencing a parameter provider.")
