...
public class ConnectionDiagnosticsSnapshotDTO   {
  ...
  private List<RemoteQueuePartitionDTO> remoteQueuePartitions = new ArrayList<RemoteQueuePartitionDTO>();
  ...
  **/
  @ApiModelProperty(example = "null", value = "The Node Identifier that this information pertains to")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The local queue partition, from which components can pull FlowFiles on this node.")
