...
public class VersionedProcessor   {
  ...
  **/
   ...
   * @return style
  **/
  @ApiModelProperty(example = "null", value = "Stylistic data for rendering in a UI")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Indicates whether the processor should be scheduled to run in event or timer driven mode.")
